...
void main(){
    ...
    float LightmapSmooth =  smoothstep(0.915 ,smoothstep(0.91,0.935,1.0 ),Lightmap.y)*Lightmap.x;
    float LightmapSmooth2 =  smoothstep(0.85,0.9,Lightmap.y)*Lightmap.x;
    ...
    vec3 Diffuse = Albedo *LightmapSmoothColor.rgb* (LightmapColor +1+ Ambient);
    /* DRAWBUFFERS:0 */
